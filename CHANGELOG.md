...
### Fixed
- fix: restore @capacitor/app + @capacitor/browser deps lost in PR #43 merge resolution (`ddf1a44`)


## [0.1.74] — 2026-05-12

### Documentation
- docs: competitive UX research vs Granola/Otter/Fireflies/Tactiq/Read.ai (`f0915b7`)
