...
/**
 * /sign-up — create an account via Google OAuth or email OTP.
 *
        ...
        {stage === "sent" ? (
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            ...
            <button
              ...
              className="w-full min-h-[44px] rounded-md bg-emerald-400 px-4 py-2 text-sm font-semibold text-neutral-950 transition hover:bg-emerald-300 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {stage === "sending" ? "Sending..." : "Send verification link"}
            </button>
            {error ? (
