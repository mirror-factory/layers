    ...
    >
      <header style={{ marginBottom: theme.space(4) }}>
        ...
        <p style={{ color: theme.colors.textMuted, marginTop: theme.space(2) }}>
          Top-level map. Every feature, every registry, every 30-day metric.
          Auto-synced on pre-commit. Same data the agent sees at SessionStart
          via AGENTS.md&#39;s compressed block.
        </p>
      </header>
      {src ? (
        <pre
        ...
        >
          ...
          <p>
            ...
            <code style={{ fontFamily: theme.font.mono }}>
              pnpm exec tsx scripts/sync-project-index.ts
            </code>
          </p>
        </div>
      )}
