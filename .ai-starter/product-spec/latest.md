...
anchors:
  ...
  design: DESIGN.md
  alignment: .ai-starter/alignment/latest.md
---
...
## Success Metrics
- At least 5 qualified conversations, 2 strong follow-ups, or 1 paid/LOI-style signal for the narrow MVP.
...
## Milestones
- m0: Spec approved or explicitly bypassed
- m1: Narrow MVP slice planned with evidence requirements
- m2: First user journey verified with browser proof
...
- [MFDR technical decision record](.ai-starter/mfdr/latest.md)
- [Design contract](DESIGN.md)
- [Alignment file](.ai-starter/alignment/latest.md)
