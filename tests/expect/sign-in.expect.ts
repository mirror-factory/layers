/**
 * Auto-scaffolded by scaffold-expect-tests.ts for /sign-in.
 *
 ...
 *
 * Run:
 *   pnpm exec expect tui -u http://localhost:3001/sign-in \
 *     --browser-mode headless \
 *     -m "Use tests/expect/sign-in.expect.ts as the route plan. Verify the page loads, the primary action is discoverable, empty/loading/error states are readable, and mobile layout has no horizontal overflow." \
 *     -y
 *
...
export const EXPECT_ROUTE = "/sign-in";
